...
CALL ProcessLoanReturn(1, '2024-03-28');
-- Result: The return date of the loan with id 1 will be updated to '2024-03-28'. Since it's not overdue, the transaction will be committed.

CALL ProcessLoanReturn(3, '2024-01-10');
...
CALL ProcessLoanReturn(4, '2024-03-15');
-- Result: The return date of the loan with id 4 will be updated to '2024-03-15'. Since it's not overdue, the transaction will be committed.
